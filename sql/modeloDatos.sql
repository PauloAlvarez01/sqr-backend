...
-- Table: TURNO_EQUIPO
CREATE TABLE TURNO_EQUIPO (
                              id_equipo int  NOT NULL,
                              id_turno int  NOT NULL,
                              CONSTRAINT TURNO_EQUIPO_pk PRIMARY KEY (id_equipo,id_turno)
);
...
-- Reference: FK_TURNO_EQUIPO_EQUIPO (table: TURNO_EQUIPO)
ALTER TABLE TURNO_EQUIPO ADD CONSTRAINT FK_TURNO_EQUIPO_EQUIPO
...
-- Reference: FK_TURNO_EQUIPO_TURNO (table: TURNO_EQUIPO)
ALTER TABLE TURNO_EQUIPO ADD CONSTRAINT FK_TURNO_EQUIPO_TURNO
    FOREIGN KEY (id_turno)
        REFERENCES TURNO (id_turno)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
